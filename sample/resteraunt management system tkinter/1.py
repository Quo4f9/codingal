...
class RestaurantOrderManagement:
    def __init__(self,root):
        self.root=root
        self.root.title("restarunt manager app")
        ...
        ttk.Label(frame,text="Restarunt order management",font=("Arial",20,"bold")).grid(row=0,columnspan=3,padx=18,pady=10)
        self.menu_labels={}
    ...
    def setup_background(self, root):
        ...
        original_image = tk.PhotoImage(file="resteraunt management system tkinter/background.png")
